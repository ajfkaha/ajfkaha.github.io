var index = 0
    $('.content1-l button').click(function () {
        ...
        if (index % 2 == 1) {
            ...
            $('.content1-l img').attr("style",
                "bottom: 0px;")
            $('.content1-l').attr("style",
                "width: 63%;")
            $('.content1-r').attr("style",
                "width: 37%;")
            $('.img-content').attr("style",
                "padding: 10px; transform: scale(1);")
            $('.img-content img').attr("style",
